...
public class BookingServiceImpl implements BookingService {
    ...
    public BookingResponse createBooking(Long userId, CreateBookingRequest request) {
        ...
        if (request.getContactEmail() != null) {
            String tourDateStr = schedule.getTourDate() != null 
        ...
        // Send notification
        notificationService.createBookingConfirmationNotification(userId, booking.getId(), bookingCode);
    ...
    public BookingResponse cancelBooking(Long userId, Long bookingId, CancelBookingRequest request) {
        ...
        if (booking.getContactEmail() != null) {
            emailService.sendBookingCancellation(
                    ...
                    request.getReason() != null ? request.getReason() : "Khách hàng yêu cầu hủy",
                    refundAmount
            );
        }
