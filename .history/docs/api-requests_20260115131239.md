...
`CreateProvinceRequest` (multipart): gửi **chỉ** field cần thay đổi  
...
`CreateCultureItemRequest`: gửi **chỉ** field cần thay đổi  
...
**PUT** `/api/artisans/{id}`  
`CreateArtisanRequest`: gửi **chỉ** field cần thay đổi  
...
`CreateBlogPostRequest`: gửi **chỉ** field cần thay đổi  
...
**PUT** `/api/videos/{id}`  
`CreateVideoRequest`: gửi **chỉ** field cần thay đổi  
...
`CreateUserMemoryRequest`: gửi **chỉ** field cần thay đổi  
...
**PUT** `/api/vouchers/{id}`  
`CreateVoucherRequest`: gửi **chỉ** field cần thay đổi  
