...
import swd.coiviet.dto.request.CreateReviewRequest;
...
public class ReviewController {
    ...
    public ResponseEntity<ApiResponse<ReviewResponse>> createReview(
            @ModelAttribute @Validated CreateReviewRequest request,
            @Parameter(description = "Danh sách ảnh (tối đa 3 ảnh)", schema = @Schema(type = "array", format = "binary"))
        ...
        reviewService.findByBookingId(request.getBookingId()).ifPresent(r -> {
