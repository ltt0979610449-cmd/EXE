...
import swd.coiviet.dto.request.CreateUserMemoryRequest;
...
public class UserMemoryController {
    ...
    public ResponseEntity<ApiResponse<UserMemory>> createMemory(
            @ModelAttribute @Validated CreateUserMemoryRequest request,
    ...
    public ResponseEntity<ApiResponse<UserMemory>> updateMemory(
            ...
            @ModelAttribute CreateUserMemoryRequest request,
            @RequestParam(value = "images", required = false) MultipartFile[] images,
            @RequestParam(value = "audio", required = false) MultipartFile audio,
            @RequestParam(value = "video", required = false) MultipartFile video,
            HttpServletRequest httpRequest) {
